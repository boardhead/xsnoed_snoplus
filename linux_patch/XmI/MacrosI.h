/**
 *
 * $Id: MacrosI.h,v 1.1 2000/02/03 15:05:07 phil Exp $
 * 
...
#define FormC_X(w) \
    (((XmFormConstraintRec *)((w)->core.constraints))->form.x)

#define FormC_Y(w) \
    (((XmFormConstraintRec *)((w)->core.constraints))->form.y)

#define FormC_W(x) \
    (((XmFormConstraintRec *)((x)->core.constraints))->form.w)

#define FormC_H(w) \
    (((XmFormConstraintRec *)((w)->core.constraints))->form.h)
...
#define FCP_X(c) \
    (((XmFormConstraintRec *)(c))->form.x)

#define FCP_Y(c) \
    (((XmFormConstraintRec *)(c))->form.y)

#define FCP_W(c) \
    (((XmFormConstraintRec *)(c))->form.w)

#define FCP_H(c) \
    (((XmFormConstraintRec *)(c))->form.h)
